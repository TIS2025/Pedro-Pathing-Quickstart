...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.000724011;
    public static double STRAFE_TICKS_TO_INCHES = 0.000724011;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(0 , 0, 0);
        strafeEncoderPose = new Pose(1000, 1000, Math.toRadians(90));
